      ...
      <ul className="flex max-h-screen-top w-full flex-col gap-2 overflow-y-auto p-2 md:gap-4 md:p-6">
        ...
        {feedItems?.length === 0 && (
          <li className="w-full py-16">
            <p className="text-center text-2xl text-gray-400 dark:text-gray-300">No feeds found</p>
            <div className="mx-auto mt-4 max-w-fit text-gray-400">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 -960 960 960"
                fill="currentColor"
                className="animate-tikTak inline-block h-12 w-12"
              >
